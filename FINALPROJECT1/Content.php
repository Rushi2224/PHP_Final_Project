...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary"><a href="updatepro.php?update='.$id.'">Update</a></button>
                    <button type="button" class="btn btn-danger"><a href="Deletepro.php?deleteid='.$id.'">Delete</a></button>
                </td>
            </tr>';
    }
}
